...
<body>
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="index.html"><img src="{{('public/frontend/images/home/logo2.png')}}" alt="" /></a>
						</div>
					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="item active">
								<div class="col-sm-6">
									<h1><span>FLOWER</span>-THOR</h1>
									<h2>Trăm phần trăm HOA TƯƠI</h2>
									<p>Hoa quá là tươi.Mua đi,mua đi. </p>
							...
							<div class="item">
								<div class="col-sm-6">
									<h1><span>FLOWER</span>-THOR</h1>
									<h2>Đến là đón.Hihi</h2>
									<p>Mua thì mua khumm mua thì thoai. </p>
									<button type="button" class="btn btn-default get">Get it now</button>
								</div>
								<div class="col-sm-6">
							...
							<div class="item">
								<div class="col-sm-6">
									<h1><span>FLOWER</span>-THOR</h1>
									<h2>Free ship khi mua online </h2>
									<p>Quá là tiện lợi luoonnn :3. </p>
									<button type="button" class="btn btn-default get">Get it now</button>
								</div>
								<div class="col-sm-6">
	...
	<footer id="footer"><!--Footer-->
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright © 2013 FLOWER-THOR Inc. All rights reserved.</p>
					<p class="pull-right">Designed by <span><a target="_blank" href="http://www.themeum.com">PhuThuyMeow</a></span></p>
				</div>
			</div>
		</div>
